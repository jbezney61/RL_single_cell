...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_dim: int, n_actions: int):
        ...
        # --- MODIFIED: Added Dropout layers for regularization ---
        self.layers = nn.Sequential(
            ...
            nn.Linear(256, 128),
            nn.ReLU(),
            nn.Dropout(p=0.2), # Dropout after second activation
...
class DQNTrainer:
    ...
    def _learn(self):
        ...
        # --- ADDED: Ensure network is in training mode for dropout ---
    ...
    def _run_greedy_test(self, starting_cl, ending_cl):
        ...
        # --- ADDED: Set network to evaluation mode for deterministic testing ---
        ...
        # --- ADDED: Set network back to training mode ---
        self.policy_net.train()
