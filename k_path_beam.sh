#!/bin/bash
#SBATCH --job-name="k_search_beam_k190_n5"
...
#SBATCH --output=/home/3126294/RL/outputs/k_search_beam_k190_n5.out
#SBATCH --error=/home/3126294/RL/outputs/k_search_beam_k190_n5.err
...
/home/3126294/miniconda3/envs/average_search_env/bin/python k_search.py --k 190 --n_steps 5 --strategy beam
